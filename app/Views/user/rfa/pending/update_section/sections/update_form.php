<div class="col-lg-6 col-md-6">
   <div class="form-wizard">
      <form id="update_rfa_form">
         <fieldset class="wizard-fieldset show">
            <h5>Update Request For Assistance Form</h5>
            <div class="form-group">
               <label>Reference No.</label>
               <div class="input-group mb-3">
                  <div class="input-group-prepend">
                     <input type="text" name="year" class="form-control" value="" readonly> </div>
                  <div class="input-group-prepend">
                     <input type="text" name="month" class="form-control" value="" readonly> </div>
                  <input type="number" class="form-control  wizard-required input " value=""  name="reference_number" readonly> </div>

                   <input type="hidden" class=" " value="<?= $_GET['id'] ?>"  name="rfa_id" readonly> 
